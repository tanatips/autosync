...
public class FfcSfCardReadingHistoryHandler {
    
    private ConnectDatabase.ConnectSQLite sqliteConnection;
    private int updateCount = 0;
    private String tablename = "ffc_sf_card_reading_history";
    
    public FfcSfCardReadingHistoryHandler(ConnectDatabase.ConnectSQLite sqliteConnection) {
        this.sqliteConnection = sqliteConnection;
    }
    
    public int updateFfcSfCardReadingHistory(ConnectDatabase.ConnectSQLite sqliteConnection, String lastUpdate) throws SQLException {
        this.sqliteConnection = sqliteConnection;
    ...
    public boolean checkAndCreateTable() throws SQLException {
        try {
            ...
            Logger.getLogger(FfcSfCardReadingHistoryHandler.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
    }
    
    private boolean createTable() throws SQLException {
        String createTableSQL = "CREATE TABLE `ffc_sf_card_reading_history` ("
