...
// =============================================================================
// 0. FFC SF Person Info Handler (Complete Version)
// =============================================================================
public class FfcSfPersonInfoHandler {

    private ConnectDatabase.ConnectSQLite sqliteConnection;
    private int updateCount = 0;
    private String tablename = "ffc_sf_person_info";

    public FfcSfPersonInfoHandler(ConnectDatabase.ConnectSQLite sqliteConnection) {
        this.sqliteConnection = sqliteConnection;
    }

    public int updateFfcSfPersonInfo(ConnectDatabase.ConnectSQLite sqliteConnection, String lastUpdate) throws SQLException {
        this.sqliteConnection = sqliteConnection;
        ...
        try {
            ...
            while (rs.next()) {
                if (rs.getString("dateupdate") != null) {
                    System.out.print(tablename + ".dateupdate = " + rs.getString("dateupdate"));
    ...
    public boolean checkAndCreateTable() throws SQLException {
        try {
            ...
            Logger.getLogger(FfcSfPersonInfoHandler.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
    }

    private boolean createTable() throws SQLException {
        String createTableSQL = "CREATE TABLE `ffc_sf_person_info` ("
