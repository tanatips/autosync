...
public class JhcisToAndroid implements Runnable{
    ...
    public void run() 
    {
        try {
            ...
            // Android 2.x - 3.x
            adbManager.writeAdbBatFileCopyPush(Service.Service.serialDeviceConnect, 
                    "../FFC-Xml/FFC-Stat-population.xml", "/sdcard/Android/data/th.in.ffc/files/FFC-Stat-population.xml");
            // Android 4.x
            //adbManager.writeAdbBatFileCopyPush(Service.Service.serialDeviceConnect, 
            //      "../FFC-Xml/FFC-Stat-population.xml", "/storage/sdcard0/Android/data/th.in.ffc/files/FFC-Stat-population.xml");
