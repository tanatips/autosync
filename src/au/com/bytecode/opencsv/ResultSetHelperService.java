...
public class ResultSetHelperService implements ResultSetHelper {
    ...
    private String handleDouble(ResultSet rs, int columnIndex) throws SQLException {
        double doubleValues = rs.getDouble(columnIndex);
        return rs.wasNull() ? "" : String.valueOf(doubleValues);
    }
    ...
    private String getColumnValue(ResultSet rs, int colType, int colIndex)
		...
		switch (colType)
		{
			...
			case Types.REAL:
			case Types.NUMERIC:
                            value = handleDouble(rs, colIndex);
			    break;
